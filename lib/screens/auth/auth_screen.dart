...
import 'package:stillnote/screens/auth/comps/auth_password_field.dart';
...
class AuthScreen extends StatelessWidget {
  ...
  AuthScreen(this.pageName, {super.key});
      ...
      children: [
        ...
        Material(
          ...
          child: TextFormField(
            ...
            decoration: getTextFieldDecoration("Username", XIcons.profile),
          ),
        ),
        const SizedBox(height: 20),
        Material(
          ...
          child: TextFormField(
            ...
            textInputAction: TextInputAction.next,
            decoration: getTextFieldDecoration("Your Name", XIcons.text),
          ),
        ),
        const SizedBox(height: 20),
        AuthPasswordField(
  ...
  Material getEmailTextField(ColorScheme colorScheme) {
    return Material(
      ...
      child: TextFormField(
        ...
        decoration: getTextFieldDecoration("Email", XIcons.mail),
      ),
    );
  }

  InputDecoration getTextFieldDecoration(String hint, String assetName) {
    return InputDecoration(
      border: InputBorder.none,
      hintText: hint,
      prefixIcon: Padding(
        padding: const EdgeInsets.symmetric(horizontal: 10),
        child: SvgIcon(assetName, width: 20),
      ),
